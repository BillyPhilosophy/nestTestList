...
import { MyFileValidator } from './fileValidator';
...
export class AppController {
  ...
  uploadFiles2(@UploadedFile(FileSizeValidationPipe) file: Express.Multer.File, @Body() body: any) {
    console.log('body', body);
    console.log('files', file);
  }

  @Post('fff')
  @UseInterceptors(FileInterceptor('fff', {
    dest: 'uploads'
  }))
  ...
  @Post('ggg')
  @UseInterceptors(FileInterceptor('ggg', {
    dest: 'uploads'
  }))
  ...
  @Post('hhh')
  @UseInterceptors(FileInterceptor('hhh', {
    dest: 'uploads'
  }))
  uploadFile5(@UploadedFile(new ParseFilePipe({
    validators: [
      new MyFileValidator({}),
    ],
  })) file: Express.Multer.File, @Body() body: any) {
